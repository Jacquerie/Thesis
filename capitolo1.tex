...
\begin{example}
	Sia \(L\) il grafo su tre vertici con due archi, rappresentato a sinistra. Allora \(L^2\) è rappresentato a destra. TODO: Disegno 
\end{example}
Osserviamo che la coppia \((G^t, \mathbf{P}^t)\), dove \(\mathbf{P}^t\) è definita da \eqref{eq:probability}, è ancora un grafo probabilistico. 
