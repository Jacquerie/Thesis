...
\begin{example}
	...
	\begin{figure}
		\centering \tikzstyle{vertex}=[circle,draw=black!100,thick,minimum size=1cm] 
		\begin{tikzpicture}
			[scale=2] \node (b) at (0,0) [vertex] {b}; \node (a) at (2,0) [vertex] {a}; \node (c) at (1,1.732) [vertex] {c}; \draw (b.0) -- (a.180) [thick]; \draw (b.60) -- (c.240) [thick];
			...
			\draw (aa.0) -- (ab.180) [thick]; \draw (ab.0) -- (ac.180) [thick];
			
			\draw (ba.0) -- (bb.180) [thick]; \draw (bb.0) -- (bc.180) [thick];
			
			\draw (ca.0) -- (cb.180) [thick]; \draw (cb.0) -- (cc.180) [thick];
			
			\draw (aa.90) -- (ba.270) [thick]; \draw (ba.90) -- (ca.270) [thick];
			
			\draw (ab.90) -- (bb.270) [thick]; \draw (bb.90) -- (cb.270) [thick];
			
			\draw (ac.90) -- (bc.270) [thick]; \draw (bc.90) -- (cc.270) [thick];
			
			\draw (aa.45) -- (bb.225) [thick]; \draw (ba.315) -- (ab.135) [thick];
			
			\draw (ab.45) -- (bc.225) [thick]; \draw (bb.315) -- (ac.135) [thick];
			
			\draw (ba.45) -- (cb.225) [thick]; \draw (ca.315) -- (bb.135) [thick];
			
			\draw (bb.45) -- (cc.225) [thick]; \draw (cb.315) -- (bc.135) [thick]; 
		\end{tikzpicture}
		\caption{Esempio di prodotto conormale.} \label{conormalexample} 
	\end{figure}
\end{example}
...
\begin{example}
	...
	\begin{figure}
		\centering 
		\begin{tikzpicture}
			\draw [->] (4,0,0) -- (5,0,0) node [right] {$x$}; \draw [->] (0,4,0) -- (0,5,0) node [above] {$y$}; \draw [->] (0,0,5) -- (0,0,6) node [below left] {$z$};
			
			\draw (4,0,0) -- (0,4,5) [thick]; \draw (0,4,0) -- (0,4,5) [thick]; \draw (0,0,5) -- (0,4,5) [thick]; \draw (4,0,0) -- (0,0,5) [thick]; \draw (4,0,0) -- (0,4,0) [thick]; \draw (0,0) -- (4,0,0) [thick, dashed]; \draw (0,0) -- (0,4,0) [thick, dashed]; \draw (0,0) -- (0,0,5) [thick, dashed]; 
		\end{tikzpicture}
