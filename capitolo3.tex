...
\begin{algorithm}
	...
	\end{algorithmic}
\end{algorithm}
Denotiamo con \(x'\) il vettore \(x\) dopo una esecuzione del corpo del while.
...
\begin{proof}
	...
	Supponiamo invece che \(K\) sia blu in \(G_j(x')\). Allora non possono esistere componenti connesse rosse, altrimenti una di esse sarebbe buona per il Lemma \ref{goodlemma} e l'algoritmo avrebbe dato precedenza a questa. TODO
