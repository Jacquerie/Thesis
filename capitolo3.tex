...
\begin{lemma}
	\label{structurelemma} Sia \(P\) un insieme parzialmente ordinato ricoperto da due catene disgiunte \(A\) e \(B\). Sia inoltre \(G=\overline{G}(P)\) 
\end{lemma}
\begin{proof}
	TODO\qed 
\end{proof}
...
\end{proof}
È immediato osservare che che la precedente dimostrazione si applichi, \emph{mutatis mutandis}, all'insieme delle componenti blu non banali. Pertanto in analoghe ipotesi esiste una compomente blu che sia buona.
