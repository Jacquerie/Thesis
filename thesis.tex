...
Il concetto di entropia di grafo fu introdotta da Janos K\"oner come possibile risposta al problema di assegnare ad un grafo un numero che ne rappresenti la complessità, ma che allo stesso tempo ammetta un'interpretazione in termini di teoria dell'informazione.
...
Grazie ad alcune sue proprietà peculiari, ad esempio una particolare forma di subadditività, l'entropia di grafo ha trovato applicazione in campo combinatorico e algoritmico, in particolare per dimostrare particolari disuguaglianze.
...
La rigorosa definizione di entropia di un grafo comporta alcune difficoltà tecniche, la cui risoluzione costituisce l'obiettivo principale di questo lavoro. La prima sezione sarà dedicata a proporre tre possibili definizioni di entropia, la cui equivalenza sarà dimostrata nella sezione successiva. Nell'ultima sezione ne saranno enunciate le proprietà di rilievo.
